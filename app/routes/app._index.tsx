...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const [
    ...
    prisma.bundleOffer.count({ where: { shop } }),
...
const features = [
  ...
  {
    title: "Bundle Offers",
    description: "Show shoppers how close they are to a 2 for deal",
    route: "/app/bundle-offers",
    key: "bundleOffers" as const,
  },
  {
