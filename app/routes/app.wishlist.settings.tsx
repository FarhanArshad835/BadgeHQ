      ...
      <BlockStack gap="300">
        ...
        <InlineGrid columns={{ xs: 1, md: 2 }} gap="300">
          ...
          <BlockStack gap="300">
            ...
            {/* The stats and the CSV live on the activity page, which is now what
                Wishlist opens to. Repeating the export here would just be a second
                place to look for the same button. */}
            <Banner tone="info">
