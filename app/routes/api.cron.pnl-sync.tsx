...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  // Which shops to sync: those with P&L enabled OR that already have financials
  // (so a shop that used it keeps its cache warm without re-toggling).
  ...
  const shops = Array.from(new Set([...enabled, ...withData].map((s) => s.shop)));
